...
<head>
  <meta charset="UTF-8" />
  <title>Lecturer Login | MyInternship</title>
    ...
    <div class="row w-100 g-0">
      ...
      <div class="col-lg-6 right-section">
        <div class="card card-login">
          ...
          <form method="POST">
            <div class="mb-3">
              <label for="username">Lecturer Username or Email <span class="text-danger">*</span></label>
              <input type="text" class="form-control" id="username" name="username"
                placeholder="Enter Your Lecturer ID or Email" required>
              <small class="form-text">
                <b>Polibatam Lecturer ?</b><br>
                Use your learning account or your MyInternship Lecturer ID.
              </small>
            </div>
      ...
      try {
        ...
        if (data.success) {
          ...
          Toast.fire({
            icon: 'error',
            title: 'Login Failed',
            html: `${data.message || 'Please check your credentials !'}`,
            timer: 3000
          });
        }
