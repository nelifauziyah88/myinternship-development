                                    ...
                                    <li>
                                        <div class="user-box">
                                            ...
                                            <div class="u-text">
                                                ...
                                                <p class="text-muted">Lecturer at : <br><?= htmlspecialchars($nama_kampus) ?></p>
                        ...
                        <div class="info">
                            <a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
                                <span>
                                    ...
                                    <span class="user-level">NIK: <?= htmlspecialchars($user['nim_nik_unit']) ?></span>
                                    <span class="user-level wrap2">Lecturer at: <br><?= htmlspecialchars($nama_kampus) ?></span>
                                </span>
                            </a>
